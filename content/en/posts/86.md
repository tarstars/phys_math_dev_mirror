...
source_hash: d9660e6f878adce6cf4ad30367f4aa583395cbe6a3483c7875dea19a8246d948
...
summary: MapReduce in The Farmer Was Replaced Code discussion. Part I. 27 years ago
  ...
  web page. ([the paper](<https://snap.stanford.edu/class/cs224w-r
title: MapReduce in The Farmer Was Replaced
updated_at: '2026-03-01T13:24:17.666474+00:00'
---
...
27 years ago Google was born. One of its key ideas was PageRank – a “credibility” score for a web page. ([the paper](<https://snap.stanford.edu/class/cs224w-readings/Brin98Anatomy.pdf>)) To compute it quickly, you need a lot of computational power. One option is to build a specialized supercomputer, but Google as a company rejected that path. Instead, they decided to use large arrays of commodity‑class hardware, connected into a network. You have to carefully orchestrate programs that run on such a platform, and back then writing distributed computation was almost like witchcraft.

In 2004 a new era of distributed computation started – the era of MapReduce platforms (see [the paper](<https://static.googleusercontent.com/media/research.google.com/ru//archive/mapreduce-osdi04.pdf>) by Dean and Ghemawat). The idea is simple: split your data into pieces, run the same “map” function in parallel on many machines, then combine (“reduce”) the partial results into one final result.
...
I wanted a tiny “framework” to assign tasks to drones and run them in parallel. Because we take measurements, we also need to collect data from different drones and merge it. The core of this framework is the function `drone_map_reduce` from the [script](<https://github.com/tarstars/tfwr/blob/839d8bd0b4d164a809f1f37d6c3a2e8969c0425d/sunflowers_ach.py#L18>).
