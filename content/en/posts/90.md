...
source_hash: 900712183a26883bfcd795ac334b9ae3ebd1b1b881095c7c5df41bc45501e11a
source_url: https://t.me/phys_math_dev/90
summary: MapReduce in The Farmer Was Replaced Code discussion. Part II. In the [previous
  post](<https://t.me/phys_math_dev/86>) we discussed [the code](<https://github.com/tarstars/tfwr/blob/main/sunflowers_ach.py>)
  which uses ma
title: MapReduce in The Farmer Was Replaced
updated_at: '2026-03-01T13:24:18.073127+00:00'
---
...
In the [previous post](<https://t.me/phys_math_dev/86>) we discussed [the code](<https://github.com/tarstars/tfwr/blob/main/sunflowers_ach.py>) which uses map reduce approach to farm sunflowers. We reviewed the drone_map_reduce(objects, f_map, f_red) function line-by-line and realized that:
...
I'm not sure that one post can contain so much code, so let's use links to github. Starting from this [line](<https://github.com/tarstars/tfwr/blob/839d8bd0b4d164a809f1f37d6c3a2e8969c0425d/sunflowers_ach.py#L113>) I convert a dictionary from format (x,y) -> h to h -> [(x1, y1), (x2, y2), ...]. For each height of sunflower now we have a list of cells with sunflowers of this height in these cells.

[Finally](<https://github.com/tarstars/tfwr/blob/839d8bd0b4d164a809f1f37d6c3a2e8969c0425d/sunflowers_ach.py#L120>) , we use our map_reduce approach to collect all sunflowers in a correct order. "gather_all" is a factory function for this task.